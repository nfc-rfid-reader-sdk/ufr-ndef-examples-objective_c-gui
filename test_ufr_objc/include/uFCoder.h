...
#if __linux__ || __linux || __APPLE__
#	define DL_API
#else
// WINDOWS
...
DL_API
UFR_STATUS WriteEmulationNdef(uint8_t tnf, uint8_t *type, uint8_t type_length, uint8_t *_id, uint8_t id_length, uint8_t *payload, uint32_t payload_length);
